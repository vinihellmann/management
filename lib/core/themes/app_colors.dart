...
class AppColors {
  static const Color primary = Color.fromARGB(255, 255, 115, 0);
  static const Color secondary = Color(0xFF5865F2);
  static const Color tertiary = Color.fromARGB(255, 57, 160, 113);
  ...
  static const Color lightInputBorder = Color(0xFFD1D3D5);
  ...
  static const Color darkInputFill = Color.fromARGB(255, 40, 42, 44);
  static const Color darkInputBorder = Color(0xFF4F545C);
  static const Color darkError = Color(0xFFFF3030);
}
